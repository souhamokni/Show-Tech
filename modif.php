    	...
    	<div class="product">
            ...
            <?php
                ...
                $_SESSION["id"]=$row["id"];
                    ...
                    Type: <br>
                    <input disabled  type='text' value='".$row["typee"]."'> <br>
                    NomP: <br>
                    <input value='".$row["nameP"]."' name='namep' type='text'  style='width: 200px'  placeholder='donner le nom du produit...'/> <br><br>
                    ...
                    <textarea
                                    ...
                                    rows='4' 
                                    name='description' 
                                    placeholder='donner le descriotion du produit..     '> ".$row["descriptions"]."</textarea><br><br>
                    prix: <br>
                    <input type='text' name='prix' value='".$row["prix"]."' > <br>
                    image: <br> 
                    <img width='144px' hight='144px' src='images/product/".$row["images"]."' alt='image' /> <br>
                    <input type='file' name='image'><br>   

                                            
                    <input type='submit' value='valider' class='submit_btn'> ";
