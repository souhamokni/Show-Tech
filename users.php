                ...
                while($row = $result->fetch_assoc())     {
                    echo "<div class='product_box'>
                    	<div class='img_box'><span></span>
	                        <img width='144px' hight='144px' src='images/users.png' alt='image' />
			        	</div>
                        <h2>  <a href='productdetail.php?id=".$row["id"]."'><strong>Nom: <br> </strong>".$row["nom"]."</a></h2> 
                        <h2>  <a href='productdetail.php?id=".$row["id"]."'><strong>Prenom: <br> </strong>".$row["prenom"]."</a></h2>
                        <h2>  <a href='productdetail.php?id=".$row["id"]."'><strong>Email:<br> </strong>".$row["email"]."</a></h2>
                    </div>";
                }
            ?>
		</div>
