    ...
    <?php
    	...
    	echo"<div class='product'>
        	<div class='col col_2 product_preview'>
	            <a rel='lightbox' href='./images/product/".$row["images"]."'><img width='400px' hight='600px' src='./images/product/".$row["images"]."' class='left' alt='image' /></a>
                <div class='clear'></div>
            </div>
            <h2>".$row["nameP"]."</h2>
            <div class='col col_2 product_detail'>
              ...
              <p class='price'>".$row["prix"]."<span>Avaliability: <strong>In stock</strong></span></p>
                <div class='clear h20'></div>
              <p class='add_to_cart'>Quantity <input type='number' value='1' style='width: 50px; text-align: left' /></p>
